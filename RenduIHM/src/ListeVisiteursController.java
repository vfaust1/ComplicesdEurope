...
public class ListeVisiteursController {
    private Plateforme plateforme;

    @FXML
    private TableView<Student> visiteursTable;
    @FXML
    ...
    public void setPlateforme(Plateforme plateforme) {
        ...
        if (plateforme != null) {
            visiteursTable.getItems().setAll(plateforme.getVisitor());
        }
    }
    ...
    private void handleVoirProfilButton(ActionEvent event) {
        Student selectedStudent = visiteursTable.getSelectionModel().getSelectedItem();
        if (selectedStudent != null) {
            try {
                ...
                Stage window = (Stage) visiteursTable.getScene().getWindow();
